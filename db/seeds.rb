...
f4 = Funding.create!(user_id: u2.id, amount: 20.00)
f5 = Funding.create!(user_id: u2.id, amount: 30.00)
f6 = Funding.create!(user_id: u2.id, amount: 25.00)
f7 = Funding.create!(user_id: u2.id, amount: 30.00)
f8 = Funding.create!(user_id: u3.id, amount: 30.00)
f9 = Funding.create!(user_id: u1.id, amount: 20.00)
f10 = Funding.create!(user_id: u1.id, amount: 20.00)
f11 = Funding.create!(user_id: u1.id, amount: 20.00)
f12 = Funding.create!(user_id: u1.id, amount: 20.00)
f13 = Funding.create!(user_id: u1.id, amount: 20.00)
f14 = Funding.create!(user_id: u1.id, amount: 20.00)
f15 = Funding.create!(user_id: u1.id, amount: 20.00)
...
ProductFunding.create!(product_id: p6.id, funding_id: f8.id)
ProductFunding.create!(product_id: p2.id, funding_id: f9.id)
ProductFunding.create!(product_id: p1.id, funding_id: f10.id)
ProductFunding.create!(product_id: p4.id, funding_id: f11.id)
ProductFunding.create!(product_id: p3.id, funding_id: f12.id)
ProductFunding.create!(product_id: p5.id, funding_id: f13.id)
ProductFunding.create!(product_id: p4.id, funding_id: f14.id)
ProductFunding.create!(product_id: p2.id, funding_id: f15.id)



Share.create!(user_id: u1.id, product_id: p2.id)
Share.create!(user_id: u1.id, product_id: p6.id)
